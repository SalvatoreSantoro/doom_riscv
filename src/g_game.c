...
#include <stdio.h>
static const char __attribute__((unused)) rcsid[] = "$Id: g_game.c,v 1.8 1997/02/03 22:45:09 b1 Exp $";
...
void G_DoLoadLevel(void) {
    ...
    if ((gamemode == commercial) || (gamemission == pack_tnt) || (gamemission == pack_plut)) {
